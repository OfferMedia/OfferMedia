...
var bot_token = '5776745419:AAEbryu4x4Sn38DDpkXmhTGlml206dNXDlc'; //YOUR BOT TOKEN HERE

var bot_name = 'CashBacK_PtBot'; // Bot Name
...
var mongo_url = 'mongodb+srv://Krishnabots:Krishnabotse@cluster0.rsqqngv.mongodb.net/?retryWrites=true&w=majority'; // Your Mongo URL Here
            ...
            if (flag == channel.length) {
                ...
                if (statdata.length == 0) {
                    ...
                    ctx.reply(
                        ...
                        '<b>📊 Bot Live Stats 📊\n\n📤 Total Payouts : 0 ' + currency + '\n\n💡 Total Users: ' + members.length + ' Users\n\n✅ Created By : <a href="tg://user?id=1449999447">Krishna ★★</a></b>' , { parse_mode: 'html', reply_markup: { keyboard: [['💰 Balance'], ['👫 Invite', '🎁 Bonus', '🗂 Wallet'], ['💵 Withdraw', '📊 Statistics']], resize_keyboard: true } }
